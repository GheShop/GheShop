        ...
        <div class="hidden-xs col-sm-2 dashboard-nav" id="dashboard-nav">
            ...
            <div class="nav-menu-items">
                <ul class="nav-menu">
                    ...
                    <li><a href="#"><span class="glyphicon glyphicon-bitcoin"></span><span>Categories</span></a></li>
                    <li><a href="#"><span class="glyphicon glyphicon-camera"></span><span>Products</span></a></li>
                    <li><a href="#"><span class="glyphicon glyphicon-calendar"></span><span>About</span></a></li>
                </ul>
            </div>
        </div>
        {{--Content-Main--}}
